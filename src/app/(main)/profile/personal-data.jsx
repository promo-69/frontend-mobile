...
export default function PersonalDataScreen() {
  ...
  const { control, handleSubmit, getValues, reset, formState: { isDirty, dirtyFields } } = useForm({
    defaultValues: {
      firstName: '',
      lastName: '',
      phoneNumber: '',
  ...
  return (
    <ScreenWrapper>
      ...
      <View style={styles.header}>
        ...
        <AppText variant="h2" style={styles.headerTitle}>Datos Personales</AppText>
      </View>

      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <AppText variant="body" style={styles.description}>
          Mantén actualizada tu información de contacto. Estos datos no son públicos y se usan solo para la gestión de tus entradas.
        </AppText>
        ...
        <View style={styles.inputsGroup}>
          <Controller
            control={control}
            name="firstName"
            rules={{ required: 'El nombre es obligatorio', validate: validateNames }}
            render={({ field: { onChange, onBlur, value }, fieldState: { error } }) => (
              <Input label="Nombres" value={value} onBlur={onBlur} onChangeText={onChange} error={error?.message} autoCapitalize="words" />
            )}
          />
          ...
          <Controller
            control={control}
            name="lastName"
            rules={{ required: 'El apellido es obligatorio', validate: validateNames }}
            render={({ field: { onChange, onBlur, value }, fieldState: { error } }) => (
              <Input label="Apellidos" value={value} onBlur={onBlur} onChangeText={onChange} error={error?.message} autoCapitalize="words" />
            )}
          />
          ...
          <Controller
            ...
            render={({ field: { onChange, onBlur, value }, fieldState: { error } }) => (
              <Input label="Teléfono Móvil" value={value} onBlur={onBlur} onChangeText={onChange} error={error?.message} keyboardType="phone-pad" />
            )}
          />
          ...
          <Controller
            ...
            name="personalEmail"
            render={({ field: { onChange, onBlur, value }, fieldState: { error } }) => (
              <Input label="Correo Alternativo" value={value} onBlur={onBlur} onChangeText={onChange} error={error?.message} keyboardType="email-address" autoCapitalize="none" />
            )}
          />
        </View>
      </ScrollView>
