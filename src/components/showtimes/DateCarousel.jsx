        ...
        {weekdays.map((item) => {
          ...
          return (
            ...
            >
              ...
              <Text style={[styles.monthLabel, isActive && styles.monthActive, item.disabled && styles.textDisabled]}>
                {item.month || 'JUN'}
              </Text>
...
const styles = StyleSheet.create({
  ...
  dateCard: { width: 70, height: 95, borderRadius: 12, borderWidth: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 8 },
  cardActive: { backgroundColor: '#7B1A82', borderColor: 'rgba(255, 255, 255, 0.25)', elevation: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84 },
  cardInactive: { backgroundColor: 'rgba(35, 22, 64, 0.4)', borderColor: 'rgba(255, 255, 255, 0.1)' },
  cardDisabled: { opacity: 0.25, backgroundColor: 'rgba(255, 255, 255, 0.01)', borderColor: 'transparent' },
  dayLabel: { fontSize: 10, fontWeight: 'bold', letterSpacing: 0.5 },
  textActive: { color: '#f4b400' },
  textInactive: { color: '#B0A8C5' },
  monthLabel: { fontSize: 9, fontWeight: '700', color: 'rgba(255, 255, 255, 0.4)', marginVertical: 2, textTransform: 'uppercase' },
